...
| `admissionController.image.tag`                  | Vertical Pod Autoscaler image tag (admission controller component)                                           | `0.6.3`                                                                             |
...
| `recommender.image.tag`                          | Vertical Pod Autoscaler image tag (recommender component)                                                    | `0.6.3`                                                                             |
...
| `updater.image.tag`                              | Vertical Pod Autoscaler image tag (updater component)                                                        | `0.6.3`                                                                             |
