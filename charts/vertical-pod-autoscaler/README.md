...
| `admissionController.image.tag`                          | Image tag                                                                                             | `0.9.0`                                                                             |
...
| `admissionController.priorityClassName`                  | priorityClassName for pod priority and pre-emption                                                    | `{}`                                                                                |
...
| `recommender.image.tag`                          | Image tag                                                                                             | `0.9.0`                                                                     |
...
| `recommender.priorityClassName`                  | priorityClassName for pod priority and pre-emption                                                    | `{}`                                                                        |
...
| `updater.image.tag`                          | Image tag                                                                                             | `0.9.0`                                                                 |
...
| `updater.priorityClassName`                  | priorityClassName for pod priority and pre-emption                                                    | `{}`                                                                    |
